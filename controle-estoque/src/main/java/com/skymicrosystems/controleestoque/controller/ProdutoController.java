...
import com.skymicrosystems.controleestoque.forms.ProdutoSearchForm;
...
public class ProdutoController {
    ...
    public String paginate(Model model, ProdutoSearchForm searchForm, RedirectAttributes redirAttrs) {
		...
		try { 
	        ...
	        model.addAttribute("estoqueProdutoForm", new EstoqueProduto());
    ...
    public String add(@Valid Produto produto, BindingResult result, Model model, RedirectAttributes redirAttrs) {
        ...
        try {
        	...
        	produto.setCodigo(produtoServiceImpl.proximoCodigo());
    ...
    public String showCopyForm(@PathVariable("id") long id, Model model, RedirectAttributes redirAttrs) {
		...
		Produto produto = produtoServiceImpl.findById(id).get();
